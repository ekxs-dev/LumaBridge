...
- [ ] Add optional `@ffmpeg/core-mt` loading when the page is cross-origin isolated.
- [ ] Turn ffmpeg.wasm segment fallback into a buffered short-clip adapter with prefetch/backpressure instead of decode-then-present chunks.
